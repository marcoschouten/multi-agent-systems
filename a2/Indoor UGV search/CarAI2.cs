...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAI2 : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            this.sharedResults = p2_solution.getResult(terrain_manager, myGraph, root);
        ...
        private bool HavePrecedence(string carIDString)
        {
            ...
            if (carIDString == "Car2")
            {
                if (Vector3.Distance(friends[0].transform.position, friends[1].transform.position) < 10.0f)
                {
                    return false;
                }
                return true;
            ...
            if (carIDString == "Car3")
            {
                if (Vector3.Distance(friends[0].transform.position, friends[2].transform.position) < 10.0f)
                {
                    return false;
                }
        ...
        private void UpdateTarget()
        {
            ...
            if (Vector3.Distance(transform.position, path[currentNode]) < 8.0f)
